...
弄(まさぐ)られて垂(た)れ流(なが)す

音(おと)のない音(おと)遍(あまね)く

名前(なまえ)を捨(す)てたのね　あなたのモザイク(MOSAIC)が
